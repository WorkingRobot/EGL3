...
#define exfat_bswap16(x) _byteswap_ushort(x)
#define exfat_bswap32(x) _byteswap_ulong(x)
#define exfat_bswap64(x) _byteswap_uint64(x)
#define EXFAT_BYTE_ORDER REG_DWORD
#define EXFAT_LITTLE_ENDIAN REG_DWORD_LITTLE_ENDIAN
#define EXFAT_BIG_ENDIAN REG_DWORD_BIG_ENDIAN
