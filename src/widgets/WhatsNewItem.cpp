...
namespace EGL3::Widgets {
    WhatsNewItem::WhatsNewItem(const Glib::ustring& Title, const std::string& ImageUrl, const Glib::ustring& Source, const Glib::ustring& Description, const Web::TimePoint& Date, Modules::ImageCacheModule& ImageCache) :
    ...
    WhatsNewItem::WhatsNewItem(const Web::Epic::Responses::GetBlogPosts::BlogItem& Item, const Web::TimePoint& Time, Storage::Models::WhatsNew::ItemSource Source, Modules::ImageCacheModule& ImageCache) :
        WhatsNewItem(
            Item.Title,
    ...
    WhatsNewItem::WhatsNewItem(const Web::Epic::Responses::GetPageInfo::GenericMotd& Item, const Web::TimePoint& Time, Storage::Models::WhatsNew::ItemSource Source, Modules::ImageCacheModule& ImageCache) :
        WhatsNewItem(
            Item.Title,
            Item.Image.value_or(""),
            Storage::Models::WhatsNew::SourceToString(Source),
    ...
    WhatsNewItem::WhatsNewItem(const Web::Epic::Responses::GetPageInfo::GenericPlatformMotd& Item, const Web::TimePoint& Time, Storage::Models::WhatsNew::ItemSource Source, Modules::ImageCacheModule& ImageCache) :
        WhatsNewItem(
            Item.Message.Title,
    ...
    WhatsNewItem::WhatsNewItem(const Web::Epic::Responses::GetPageInfo::GenericNewsPost& Item, const Web::TimePoint& Time, Storage::Models::WhatsNew::ItemSource Source, Modules::ImageCacheModule& ImageCache) :
        WhatsNewItem(
            Item.Title.value_or(""),
            Item.Image.value_or(""),
    ...
    WhatsNewItem::WhatsNewItem(const Web::Epic::Responses::GetPageInfo::GenericPlatformPost& Item, const Web::TimePoint& Time, Storage::Models::WhatsNew::ItemSource Source, Modules::ImageCacheModule& ImageCache) :
        WhatsNewItem(
    ...
    WhatsNewItem::WhatsNewItem(const Web::Epic::Responses::GetPageInfo::GenericRegionPost& Item, const Web::TimePoint& Time, Storage::Models::WhatsNew::ItemSource Source, Modules::ImageCacheModule& ImageCache) :
        WhatsNewItem(
            Item.Message.Title.value_or(""),
            Item.Message.Image.value_or(""),
            (Item.Message.SubGame.has_value() && !Item.Message.SubGame->empty()) ?
    ...
    WhatsNewItem::WhatsNewItem(const Web::Epic::Responses::GetPageInfo::EmergencyNoticePost& Item, const Web::TimePoint& Time, Storage::Models::WhatsNew::ItemSource Source, Modules::ImageCacheModule& ImageCache) :
        WhatsNewItem(
            Item.Title,
            "",
